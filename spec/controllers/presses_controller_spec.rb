...
describe PressesController do
  ...
  let(:valid_attributes) { { "head" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved press as @press" do
        ...
        post :create, {:press => { "head" => "invalid value" }}, valid_session
        assigns(:press).should be_a_new(Press)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested press" do
        ...
        Press.any_instance.should_receive(:update).with({ "head" => "MyString" })
        put :update, {:id => press.to_param, :press => { "head" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the press as @press" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Press.any_instance.stub(:save).and_return(false)
        put :update, {:id => press.to_param, :press => { "head" => "invalid value" }}, valid_session
        assigns(:press).should eq(press)
      end
