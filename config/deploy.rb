...
set :domain, "rails@kniguru" # Это необходимо для деплоя через ssh. Именно ради этого я настоятельно советовал сразу же залить на сервер свой ключ, чтобы не вводить паролей.
set :deploy_to, "/home/rails/www/#{application}"
set :use_sudo, false
...
set :scm, :git
set :repository,  "git@github.com:myprojects/myapp.git"
set :branch, "master"
